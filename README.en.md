...
The black cat holding the `.md` placard in the app icon was made by [TODO: fill in source]. If you also find it charming, drop a star on the repo.

<br clear="left">

> [!NOTE]
> Source attribution is a placeholder. Was it generated with ChatGPT 4o / Midjourney / DALL-E, or commissioned from a designer? Replace this section accordingly.
